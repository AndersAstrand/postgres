...
$node_london->append_conf('postgresql.conf', "shared_preload_libraries = 'pg_tde'");
...
is($cur_primary->safe_psql('postgres', "SELECT pg_tde_is_encrypted('t_009_tbl');"),
	't', "Table t_009_tbl is encrypted on primary");
